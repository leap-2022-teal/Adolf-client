        ...
        <div className=" bg-[#1f2937]
          flex  flex-col items-center ">
            <div className="w-[400px] bg-black bg-opacity-10 h-[50vh] rounded-[20px] shadow-black">
                <h1 className="text-white uppercase flex justify-center my-[10px] tracking-[0.4rem] text-[26px]" >Welcome</h1>
                ...
                <div className="flex gap-[20px] justify-center ">
                        <button className="w-[50%] text-[#cbd5e1] h-[2.5rem] bg-neutral-400 bg-opacity-10 rounded-[2rem] cursor-pointer ml-[-40px] ">Signin</button>
                        <a href="#" className="my-[10px] text-[13px] tracking-[0.1rem] text-white ">Signup</a>
                    </div>
                     <a href="#" className="tracking-[0.3rem] text-white text-[10px] flex justify-center my-[20px]">FORGOT PASSWORD?</a>
            </div>
        </div>
